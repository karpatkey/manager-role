...
def approve_tokens():
    ...
    reward_token_contract = get_contract(reward_token, ETHEREUM, web3=web3, abi=ABI_ALLOWANCE)
    if reward_token_contract.functions.allowance(avatar_address, UNISWAPV3_ROUTER).call() == 0:
        tx_data = get_data(reward_token, 'approve', [UNISWAPV3_ROUTER, MAX_TOKEN_AMOUNT], ETHEREUM, web3=web3)
        if tx_data is not None:
            exec_data = get_data(roles_mod_address, 'execTransactionWithRole', [reward_token, 0, tx_data, 0, 1, False], ETHEREUM, web3=web3, abi_address='0x8c858908D5f4cEF92f2B2277CB38248D39513f45')
