...
def add_liquidity():
    ...
    # tokens approvals
    approve_token(avatar_address, roles_mod_address, token0, POSITIONS_NFT, json_file, web3=web3, eth=eth)
    approve_token(avatar_address, roles_mod_address, token1, POSITIONS_NFT, json_file, web3=web3, eth=eth)
...
while True:
    ...
    if operation == '1':
        print()
        print(f"{bcolors.OKBLUE}-------------{bcolors.ENDC}")
        print(f"{bcolors.OKBLUE}--- Pools ---{bcolors.ENDC}")
        print(f"{bcolors.OKBLUE}-------------{bcolors.ENDC}")
        print()
        print('Select the pool:')
        print('1- UniswapV3 WETH/sETH2 0.3%')
        print('2- UniswapV3 WBTC/WETH 0.3%')
        print()
        pool_option = input('Enter the option: ') 
        while pool_option not in ['1','2']:
            pool_option = input('Enter a valid option (1 or 2): ')
